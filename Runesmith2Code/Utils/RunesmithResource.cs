...
{
    public static readonly Texture2D ElementsIcon = ResourceLoader.Load<Texture2D>("res://Runesmith2/images/charui/elements_all_icon.png");
    ...
    public static readonly IEnumerable<string> AssetPaths = [
        NEnhanceTabPath, NRuneManagerPath, NRunePath, NElementsCounterPath,
