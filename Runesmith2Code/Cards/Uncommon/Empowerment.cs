...
public class Empowerment : Runesmith2Card
{
        ...
        CardPlay play)
    {
        ...
        if (elements.Ignis > 0)
        {
            await CommonActions.ApplySelf<VigorPower>(choiceContext, this, elements.Ignis);
        }
        if (elements.Terra > 0)
        {
            await CommonActions.ApplySelf<BracePower>(choiceContext, this, elements.Terra);
        }
        if (elements.Aqua > 0)
        {
            await CommonActions.ApplySelf<AmpPower>(choiceContext, this, elements.Aqua);
        }
